...
public static class EnglishStrings
{
    public static readonly Dictionary<string, string> Translations = new Dictionary<string, string>
    {
        ...
        { "ServerDetail_Mods_NoUpdatesFound", "All mods are up to date" },
        ...
        { "ServerDetail_Mods_Update", "Update" },
        ...
        { "ServerDetail_Mods_UpdateCompleteSingle", "Mod updated successfully" },
