...
public static class EnglishStrings
{
    public static readonly Dictionary<string, string> Translations = new Dictionary<string, string>
    {
        ...
        { "Settings_CheckUpdates_Interval_Desc", "How often to check for updates" },
        { "Settings_MinimizeToTray", "Minimize to Tray" },
        { "Settings_MinimizeToTray_Desc", "Control whether the app minimizes to the system tray when closing or minimizing the window" },
        ...
        { "ServerDetail_Mods_Toggle", "Toggle" },
        ...
        { "ServerDetail_Plugins_Toggle", "Toggle" },
        ...
        { "Log_StoppingWithCommand", "Stopping server • Sending command..." },
