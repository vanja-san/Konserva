...
**Konserva** — это простая и функциональная программа с графическим интерфейсом для создания, настройки и запуска локальных серверов Minecraft на операционной системе Windows. Название объединяет слова «**кон**соль» и «**серв**ер», а также намекает на надёжное «консервирование» настроек и мира: всё сохраняется в целости и готово к работе в любой момент.

Утилита избавляет от необходимости вручную редактировать конфигурационные файлы или использовать командную строку. Все операции по управлению сервером выполняются через единую панель управления.
...
Проект распространяется по лицензии **MIT License** — подробности в файле [LICENSE.txt](LICENSE.txt).
...
Приложение создано с использованием отличной библиотеки **WPF UI** от Bartosz Ciechanowski и участников.

🔗 [WPF UI](https://github.com/lepoide/wpfui)

---

**Версия приложения**: 1.2.1
